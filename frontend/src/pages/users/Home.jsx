...
export default function Search() {
  ...
  return (
    <div className="overflow-y-hidden flex flex-col bg-gray-50 dark:bg-gray-900 h-screen">
              ...
              return (
                ...
                >
                  ...
                  <img
                    ...
                    alt={product.name}
                    onError={(e) => (e.target.src = "/src/assets/hero/for.jpg")}
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    {product.lastPrice ? (
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        <p className="text-orange-500 font-bold text-base">{formatPrice(product.price)} ETB</p>
                        <p className="ml-2 line-through">{formatPrice(product.lastPrice)} ETB</p>
