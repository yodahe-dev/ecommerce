    ...
    <nav className="bg-white dark:bg-gray-900 border-b dark:border-gray-800 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          <Link
            to="/"
            className="text-2xl font-bold text-indigo-600 dark:text-indigo-400 hidden sm:flex"
          >
            CollabClub
          </Link>
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      <div className="text-sm">
                        ...
                        <Link
                          to="/account"
                          className="flex items-center gap-2 px-3 py-2 rounded-lg text-white hover:bg-indigo-700 transition"
                        >
                        ...
                        <button
                          onClick={onLogout}
                          className="flex items-center w-full text-left px-4 py-3 text-red-100 hover:bg-red-700 "
                        >
